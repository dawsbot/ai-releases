...
- Company dots: Anthropic `#E08D6D`, OpenAI `#74C0A6`, Google `#6E9BF0`, Meta `#B48CE8`, DeepSeek `#5FC9E0`, Alibaba `#E86FA4`, xAI `#C9CDD6`, Mistral `#A6D65E`, Moonshot `#8FB4FF`, MiniMax `#FF9DB0`
